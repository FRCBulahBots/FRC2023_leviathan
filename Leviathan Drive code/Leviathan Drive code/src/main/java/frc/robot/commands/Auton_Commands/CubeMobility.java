...
public class CubeMobility extends SequentialCommandGroup {
    public CubeMobility(IntakeSubsystem intake, DrivetrainSubsystem drive, ExtendSubsystem extend, PivotSubsystem pivot) {
